...
const ClothesSubcategoryPage = () => {
  ...
  const filteredProducts = products.filter(
    (product) => product.category === 'clothes' && product.subcategory === subcategory
  );

  return (
    <div className="container mx-auto py-10">
      <h2 className="text-3xl font-bold text-center mb-8 capitalize">{subcategory} Clothes</h2>
...
export default ClothesSubcategoryPage;